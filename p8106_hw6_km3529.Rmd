...
There does not appear to be a distinct trend in the plot. There is a large cluster and a slight downward slope. 
...
The 95% CI for log(b0*b1) `r quantile(pull(weather_2, log_betas), probs = c(0.025, 0.975))`.
